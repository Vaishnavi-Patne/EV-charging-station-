...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($password !== $confirm_password) {
        ...
        if (mysqli_num_rows($check_result) > 0) {
            ...
            $insert_query = "INSERT INTO users (username, email, password, full_name, is_admin) 
                             VALUES ('$username', '$email', '$hashed_password', '$full_name', 1)";
...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-8 text-center">Admin Registration</h1>
    ...
    <form action="admin_register.php" method="POST" class="max-w-md mx-auto">
        <div class="mb-4">
        ...
        <button type="submit" class="w-full bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Register Admin</button>
    </form>
